...
public class Sb02 {
    public static void main(String[] args) {
           ...
           // her bir char 2 byte (16-bit) yer kaplar.
            ...
            System.out.println(sb2.capacity());//16  //34 (2 katının 2 fazlası seklınde artırma yapıyor )
        ...
        //---------------------------------
             ...
             System.out.println(sb4.capacity());//34  //44 java memorıyı duzenli kullanmak için lenght kadar artırma yapıyor
                                                       //java tasarruf yapıyor 32 i astıgı için lenght kadar yer actı
