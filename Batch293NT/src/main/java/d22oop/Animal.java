...
public class Animal {
           ...
           /*
             ...
             1) Object oluşturma bir Class içerisinde toplanır ve tüm projelerde kullanılabilirliğe olanak sağlar
             .(String gibi)
    ...
    //------------------------------------------
                 //a) Java ‘Multiple Inheritance’ i desteklemez. ‘Single Inheritance’ i destekler.-coklu perantı desteklemez
               ...
               //------------------------------------
                     //Override isleminde access modifier’larin durumlari ne
                     // olmalidir, onu ogrenelim
                   ...
                   /*
                      ...
                      */
                     /*
                       Override isleminde access modifier’larinı durumlarini ogrendık
                      ...
                      */
                      ...
                      //Soru2: static method’lar--aklına AY ı getır --override edilebilir mi?
                      //Cevap2: static method’lar override edilemezler cunku; static variable
                      // veya method’lar tum objeler icin ortaktir.
                     ...
                     /*
                       ...
                       1- Java'da "final" anahtar kelimesi (keyword) ile işaretlenen bir method, alt class'lar
                        tarafından override edilemez.
                       ...
                       Sonuc: "Final" kelimesi, programcılara kodlarını daha güvenli ve öngörülebilir hale
                        getirme, optimizasyon sağlama
    ...
    public  void eat (){
        ...
        //pi = 4; yenı deger atanamaz
    }

    public  Animal create (){//Data type Anımaldır
        return new Animal();//yenı bır anımal objesı uretıp
                            // dısarı anımal verdık
    }
    ...
    public void drink (){
        System.out.println("Anımals drınk....");
    }
