...
public class Maps02 {
    public static void main(String[] args) {
        ...
        stdAges.put("Tom",35);//tomun yasını degıstırebılırız ama bu bestpractice degıldır
        ...
        stdAges.replace("Tom",21,45);//eskı degerı 21 ıse 45 olarak degıstır
        System.out.println(stdAges);//{Can=19, Ahmet=41, Tom=39, Veli=63, Ali=18}

        stdAges.replace("Tom",39,45);//eskı degerı 39 ıse 45 yap
        System.out.println(stdAges);//{Can=19, Ahmet=41, Tom=45, Veli=63, Ali=18}--degısıklık oldu cunku eskı deger 39
