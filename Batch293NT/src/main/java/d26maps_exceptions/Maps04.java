    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            Çok iş parçacıklı (multi-threaded) ortamlar için uygundur.
              c) Synchronized:
            Synchronized'dir, yani tüm metotlar synchronized olarak işaretlenmiştir ve aynı anda sadece bir iş
            parçacığı tarafından erişilebilir.
              d) Null Key/Value:
        ...
        /*
             ...
             - HashMap:
             ek iş parçacıklı uygulamalar için idealdir  çünkü synchronized değildir(ek bir işlem ve zaman gerektirmez)
             ok iş parçacıklı ortamda kullanılacaksa, dış senkronizasyon mekanizmaları ile korunmalıdır.
             ...
             */
             ...
             /*
               ...
               */
                ...
                // countryPopulation.put(null,18000000);//hata treemaplere null eklemesı yapılamaz 3.madde
                  countryPopulation.put("Italy",null);
                  countryPopulation.put("France",null);

                  System.out.println(countryPopulation);
                  //{France=null, Germany=83000000, Italy=null, Netherlands=18000000, Türkiye=83000000, USA=400000000}
                   ...
                   **ornegin,bir takvim uygulamasında, etkinlikleri tarih sırasına göre tutmak için kullanılabilir.
                   ...
                   Müşteri veya işlem sıralarını takip etmek için LinkedHashMap tercih edilebilir.LinkedHashMap sınıfı
                   ...
                   */
                   ...
                   for (Map.Entry<String, Integer> entry : lhm.entrySet()) {
                     ...
                     */
                     ...
                     //HashMap'in varsayılan boyutu(kapasitesi) 16'dır (0 ila 15).16 adet "bucket" (kova) bulunacağı
                     // anlamına gelir.
                     // Bu "bucket"lar, HashMap içindeki anahtar-değer çiftlerini tutar. Bucket'in memory'de kapsadigi
                     // alan degiskendir.
