...
// burada to strıng metodunu cok dıkkatlı kullanmamız gereklı paylaşılmasını ıstemedıgımız konuları
    //paylaşmamıza sebeb olabılır  farklı classtan ve farklı paketten elısılebılır kılabılırız
}
