...
public class Sb03 {
    public static void main(String[] args) {
        ...
        /*--iş gorusmsesı sorusu olabılıyor
        ...
        StringBuffer multi-thread oldugu icin ayni zamanda synchronized’dir
                ...
                1) Immutable-degıstırılemeyen- String lazimsa ==> String class
                2) Mutable String lazimsa , StringBuilder veya StringBuffer
                                a) StringBuilder'i multi-thread gerekmezse kullaniriz-basıt işlerde
