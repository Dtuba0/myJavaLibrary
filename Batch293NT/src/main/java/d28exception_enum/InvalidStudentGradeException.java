...
public class InvalidStudentGradeException extends Exception{
           ...
           1- Özelleştirilmiş İstisna Mesajları: Özel istisna sınıflarınızla, belirli bir hata durumu için daha
           anlamlı ve detaylı hata mesajları oluşturabilirsiniz.

           2-Daha İyi Hata Yönetimi: Özel istisnalar sayesinde hataları daha spesifik olarak yakalayıp, uygun
            ...
            */
            //Exception yazarsak compile time(checked exceptions) cesidinde bir istisna olusur.
