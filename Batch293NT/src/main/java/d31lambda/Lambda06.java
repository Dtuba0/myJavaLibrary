...
public class Lambda06 {
    public static void main(String[] args) {
      ...
      //  int sum  = getSumFromSeventoSeventy();
       ...
       // System.out.println(getFactorial(6));//5!=120
        System.out.println(getSumsOfBetweenTwoInteger(5,12));
    ...
    public static int getSumsOfBetweenTwoInteger(int a , int b){
        ...
        return IntStream.range(a +1 , b).filter(Utils::isNumberEven).sum();//24
    }
