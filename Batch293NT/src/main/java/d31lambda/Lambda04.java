...
public class Lambda04 {
    ...
    public static void printDistinctElementLengthLessThanFive(List<String>myList){
        ...
        myList.stream().distinct().filter(t-> t.length()< 5 ).forEach(t-> System.out.println(t+" "));//Elif
    ...
    //Example 3:Write a method that converts all elements with more than 5 characters
    // in a List<String> to uppercase and returns these elements as a new list.
...
//    }
    ...
    public static void printElUniqueLowerCaseSortWithLength (List<String>myList){
        ...
        myList.
                ...
                distinct().
                map(String::toLowerCase).
                sorted(Comparator.comparing(String::length)).forEach(Utils::printInTheSameLineWithSpace);
        //forEach(t -> System.out.print(t + " ")) UTIL CLASSI ILE ISLEM YAPILDI
    }
