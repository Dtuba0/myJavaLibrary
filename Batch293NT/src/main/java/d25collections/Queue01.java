...
public class Queue01 {
    public static void main(String[] args) {
        ...
        */
        ...
        storage.add("yumurta");
        storage.add("peynir");
        storage.add(null);//linkedlist sebebıyle nullı kabul ettı
      ...
      //  emergencyQueue.add(null);HATA
        ...
        d.add("Oya");
        d.add("Tansu");
        System.out.println(d);//[Mehmet, Mahmut, Ekrem, Oya, Tansu] linkedlıst oldugu ıcın ınsert sırası
        ...
        //---------------------------------
        //ArrayDeque, Java'da çift yönlü kuyruk (double-ended queue) yapısını temsil eder (verilerini bir
        // dizi (array) içinde saklar) ve Deque arayüzünü uygular.
