...
public class Maps01 {
    public static void main(String[] args) {
        ...
        //1) Map’ler sozluk gibidir. Aciklamalidir. orn: Ali = 13 .Map’ler collections
        // degildir. Ordan miras almaz
        ...
        myMap.put("Ali Can", 25); //key tekrarli kullanildiginda son value aktif olur. Ustune yazar
                                  // {Fatma Yilmaz=25, Ali Can=25, Veli Han=18, Ayse Kaya=15}
        ...
        //--------------------------------
        //Ornek 1: myMap’deki kisilerin yaslarinin ortalamasi nedir?fatma yılmazın yasını 19 yaptık
