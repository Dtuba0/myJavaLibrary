...
public class Setts01 {
    public static void main(String[] args) {
        ...
        //Boş bır treeSet olusturulaım ve constructorına HashSetı yazalım
        ...
        System.out.println(t2 - t1);//TreeSet  932400
        System.out.println(t3 - t2);//HashSet  367100
