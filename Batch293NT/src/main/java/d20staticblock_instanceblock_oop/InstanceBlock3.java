...
public class InstanceBlock3 {
    ...
    //Instance block -- Bu classtan her object oluşturuldugunda calısır
    {
        color = "Siyah";
        fuelType = "Benzin";
    ...
    //-----------------------------------------
    //constructor - Classın objelerı olusturuldugunda calısır

    public InstanceBlock3(){
        System.out.println("Araba rengi : " + color );
        System.out.println("Araba yakıt turu : " + fuelType);
    }
    //Default olarak sıyah ve benzınle başlatmak ıstemezsek parametrelı constructor olustururuz
