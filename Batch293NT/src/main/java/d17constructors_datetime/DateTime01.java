...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        System.out.println(myDate.getDayOfYear());//276 yılın 276. gunundeyız
        ...
        LocalDate date1 = LocalDate.of(1984,5,3);
        LocalDate date2 = LocalDate.of(2010,5,4);

        System.out.println("date1 = " + date1 + " , date2 = " + date2);//date1 = 1984-05-03 , date2 = 2010-05-04
