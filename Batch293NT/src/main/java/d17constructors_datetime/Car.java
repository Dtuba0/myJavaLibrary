...
public class Car {
    ...
    6-Constructor nedir?
     ...
     Class olusturdugumuzda Java bize otomatik olarak bir constructor
      verir.
    ...
    /*
     ...
     Kendiniz constructor'inizi olusturdugunuz zaman Java default
     constructor'i siler

    *** Method ile Constructor arasindaki fark nedir? Interview Sorusu
      a)Methodlarda return type olur, constructor'larda olmaz
      b)Methodlar yaptiklari ise gore isimlendirilirler, constructorlar
       ise her zaman Class ismi ile isimlendirilirler
      c)Methodlar bir aksiyon yapmak icin olusturulur, Constructorlar
       ise object olusturmak icindir.(constructorlar objeleri
       başlatmak ve class'in başlatılmasını sağlamak için kullanılır.)
      d)Method isimleri kucuk harfle baslar, constructor isimleri
       ise class ismi ile ayni oldugu icin buyuk harf le baslar

     !!!  Parametreli constructorlar olusturarak ayni classdan
    ...
    /*
        ...
        Java’da ıkı tur constructor vardir
    ...
    public Car(String brand, String model, int year, boolean hybrid) {
        this.brand = brand;//bu classdeakı brand degerını kullanma , ben sana
        // parametre olarak gonderecegım
        this.model = model;
        this.year = year;
        this.hybrid = hybrid;
