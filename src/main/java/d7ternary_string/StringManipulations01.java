...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        char lastChar2 = s.charAt(s.length()-1);//dynamik code
        System.out.println(lastChar2);

        //lenght () -1 her zaman son indexi verir

        /*
        lenght  1 den başlar index 0 dan başlar
         */
        ...
        boolean isExist = s.contains("easy");//buyuk kucuk harf duyarlı
